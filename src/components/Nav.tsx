...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-black text-white px-6 py-4 shadow-md z-50 relative">
      ...
      {menuOpen && (
        <div className="fixed top-0 left-0 w-full h-full bg-black text-white px-6 py-8 z-50 overflow-y-auto">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold">Navigation</h2>
            <button onClick={closeMenu} className="text-white focus:outline-none text-2xl">
              ✕
            </button>
          </div>
          ...
          <div className="space-y-6">
            ...
            <Link to="/featured-books" onClick={closeMenu} className="block text-lg hover:text-amber-400">
              Stocked In-Store
            </Link>
